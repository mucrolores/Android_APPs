package com.example.mucolores.p10_expandablelistview;
...
public class ExpandableListView extends ExpandableListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ExpandableListAdapter expaListAdap = new SimpleExpandableListAdapter(this,
                groupList, android.R.layout.simple_expandable_list_item_2, new String[]{ITEM_NAME, ITEM_SUBNAME},
